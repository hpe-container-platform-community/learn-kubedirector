...
Previously we [deployed a Ubuntu Cluster](/docs/kd-user/storage#deploy-a-cluster-with-default-storage) and found that the directories `/home` and `/etc` were persisted.
